...
TEST(MessageTest, MessageWithUserName) {
  Message message(2, "room_789", "user_456", "Hello with username!", 1640995300,
                  "alice");
...
TEST(MessageTest, ToJsonWithEmptyUserName) {
  Message message(11, "room_json2", "user_json", "JSON test without username",
                  1640995600, "");
...
TEST(MessageTest, JsonRoundTrip) {
  Message original_message(100, "room_roundtrip", "user_roundtrip",
                           "Roundtrip test", 1640995900, "roundtripuser");
