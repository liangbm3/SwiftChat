...
HttpResponse &HttpResponse::withHeader(const std::string &key,
                                       const std::string &value) {
  headers_[key] = value;
  return *this;
}

HttpResponse &HttpResponse::withBody(const std::string &body_content,
